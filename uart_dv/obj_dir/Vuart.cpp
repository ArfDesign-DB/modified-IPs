...
Vuart::Vuart(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , uart_irq_o{vlSymsp->TOP.uart_irq_o}
    ...
    , __PVT__uart__DOT__u_rx_fifo{vlSymsp->TOP.__PVT__uart__DOT__u_rx_fifo}
    , __PVT__uart__DOT__u_tx_fifo{vlSymsp->TOP.__PVT__uart__DOT__u_tx_fifo}
    , rootp{&(vlSymsp->TOP)}
{
