...
void Vobi2wb___024root___configure_coverage(Vobi2wb___024root* vlSelf, bool first);

void Vobi2wb___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vobi2wb___024root___configure_coverage(this, first);
}
...
// Coverage
void Vobi2wb___024root::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
