...
#endif
            VL_FATAL_MT("../../rtl/gpio.sv", 38, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../../rtl/gpio.sv", 38, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../rtl/gpio.sv", 38, "", "Active region did not converge.");
            }
