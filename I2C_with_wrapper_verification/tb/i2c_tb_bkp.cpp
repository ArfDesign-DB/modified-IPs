...
void i2c_slave_model(Vi2c_master_top* top)
{
    ...
    //--------------------------------------------------
    // RELEASE ACK AFTER FALLING EDGE
    //--------------------------------------------------
