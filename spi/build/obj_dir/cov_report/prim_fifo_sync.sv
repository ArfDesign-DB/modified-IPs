...
%000000	  input                   clr_i,
	  // write port
 000758	  input                   wvalid_i,
 000011	  output                  wready_o,
 001339	  input   [Width-1:0]     wdata_i,
	  // read port
 000075	  output                  rvalid_o,
 000448	  input                   rready_i,
 000881	  output  [Width-1:0]     rdata_o,
	  // occupancy
%000008	  output                  full_o,
 000987	  output  [DepthW-1:0]    depth_o,
%000000	  output                  err_o
	);
 ...
 000020	        under_rst <= 1'b1;
%000002	      end else if (under_rst) begin
 010554	      verilator_coverage: (next point on previous line)

%000001	        under_rst <= ~under_rst;
	      end
	    end
 ...
 021150	      always_ff @(posedge clk_i)
 000666	        if (fifo_incr_wptr) begin
 010242	        verilator_coverage: (next point on previous line)

 000333	          storage[fifo_wptr] <= wdata_i;
	        end
	    end
