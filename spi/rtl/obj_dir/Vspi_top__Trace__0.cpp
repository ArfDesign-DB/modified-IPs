...
void Vspi_top___024root__trace_chg_sub_0(Vspi_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->chgIData(oldp+82,((vlSelf->device_addr_i 
                               >> 0xcU)),20);
    tracep->chgCData(oldp+83,((7U & ((IData)(vlSelf->device_be_i) 
                                     >> 1U))),3);
    tracep->chgIData(oldp+84,((vlSelf->device_wdata_i 
                               >> 8U)),24);
    tracep->chgCData(oldp+85,((0xffU & vlSelf->device_wdata_i)),8);
    tracep->chgCData(oldp+86,(((0x3f7U >= (0x3f8U & 
