...
VL_ATTR_COLD void Vspi_top___024root__trace_init_sub__TOP__0(Vspi_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+88,"ClockFrequency", false,-1, 31,0);
    tracep->declBus(c+89,"BaudRate", false,-1, 31,0);
    tracep->declBit(c+90,"CPOL", false,-1);
    tracep->declBit(c+90,"CPHA", false,-1);
    tracep->declBus(c+91,"AddrWidth", false,-1, 31,0);
    tracep->declBus(c+91,"DataWidth", false,-1, 31,0);
    tracep->declBus(c+92,"RegAddr", false,-1, 31,0);
    tracep->declBit(c+69,"clk_i", false,-1);
    tracep->declBit(c+70,"rst_ni", false,-1);
    tracep->declBit(c+71,"device_req_i", false,-1);
    tracep->declBus(c+72,"device_addr_i", false,-1, 31,0);
    ...
    tracep->declBit(c+80,"sck_o", false,-1);
    tracep->declBus(c+81,"byte_data_o", false,-1, 7,0);
    tracep->declBus(c+93,"SpiTxReg", false,-1, 11,0);
    tracep->declBus(c+94,"SpiStatusReg", false,-1, 11,0);
    ...
    tracep->declBus(c+83,"unused_device_addr", false,-1, 19,0);
    tracep->declBus(c+84,"unused_device_be", false,-1, 3,1);
    tracep->declBus(c+85,"unused_device_wdata", false,-1, 23,0);
    ...
    tracep->declBus(c+95,"ClocksPerBaud", false,-1, 31,0);
    tracep->declBus(c+96,"ToggleCount", false,-1, 31,0);
    tracep->declBus(c+97,"CountWidth", false,-1, 31,0);
    tracep->declBus(c+9,"count", false,-1, 0,0);
    tracep->declBus(c+98,"limit", false,-1, 0,0);
    ...
    tracep->declBit(c+90,"Pass", false,-1);
    tracep->declBus(c+100,"Depth", false,-1, 31,0);
    tracep->declBit(c+101,"OutputZeroIfEmpty", false,-1);
    tracep->declBit(c+90,"Secure", false,-1);
    tracep->declBus(c+102,"DepthW", false,-1, 31,0);
    tracep->declBit(c+69,"clk_i", false,-1);
    tracep->declBit(c+70,"rst_ni", false,-1);
    tracep->declBit(c+103,"clr_i", false,-1);
    tracep->declBit(c+2,"wvalid_i", false,-1);
    tracep->declBit(c+61,"wready_o", false,-1);
    tracep->declBus(c+86,"wdata_i", false,-1, 7,0);
    ...
    tracep->declBit(c+103,"err_o", false,-1);
    tracep->pushNamePrefix("gen_normal_fifo ");
    tracep->declBus(c+104,"PtrW", false,-1, 31,0);
    ...
    tracep->declBus(c+87,"storage_rdata", false,-1, 7,0);
    tracep->declBus(c+87,"rdata_int", false,-1, 7,0);
    tracep->pushNamePrefix("u_fifo_cnt ");
    tracep->declBus(c+100,"Depth", false,-1, 31,0);
    tracep->declBit(c+90,"Secure", false,-1);
    tracep->declBus(c+104,"PtrW", false,-1, 31,0);
    tracep->declBus(c+104,"DepthW", false,-1, 31,0);
    tracep->declBit(c+69,"clk_i", false,-1);
    tracep->declBit(c+70,"rst_ni", false,-1);
    tracep->declBit(c+103,"clr_i", false,-1);
    ...
    tracep->declBus(c+60,"depth_o", false,-1, 6,0);
    tracep->declBit(c+103,"err_o", false,-1);
    tracep->declBus(c+99,"WrapPtrW", false,-1, 31,0);
...
VL_ATTR_COLD void Vspi_top___024root__trace_full_sub_0(Vspi_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullIData(oldp+83,((vlSelf->device_addr_i 
                                >> 0xcU)),20);
    tracep->fullCData(oldp+84,((7U & ((IData)(vlSelf->device_be_i) 
                                      >> 1U))),3);
    tracep->fullIData(oldp+85,((vlSelf->device_wdata_i 
                                >> 8U)),24);
    tracep->fullCData(oldp+86,((0xffU & vlSelf->device_wdata_i)),8);
    tracep->fullCData(oldp+87,(((0x3f7U >= (0x3f8U 
                                             ...
                                             | (vlSelf->spi_top__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__storage[
                                                ...
                                                (0x18U 
                                                 & ((IData)(vlSelf->spi_top__DOT__u_tx_fifo__DOT__gen_normal_fifo__DOT__u_fifo_cnt__DOT__rptr_wrap_cnt_q) 
                                                    << 3U)))))
                                 : 0U)),8);
    tracep->fullIData(oldp+88,(0x2faf080U),32);
    tracep->fullIData(oldp+89,(0xbebc20U),32);
    tracep->fullBit(oldp+90,(0U));
    tracep->fullIData(oldp+91,(0x20U),32);
    tracep->fullIData(oldp+92,(0xcU),32);
    tracep->fullSData(oldp+93,(0U),12);
    tracep->fullSData(oldp+94,(4U),12);
    tracep->fullIData(oldp+95,(4U),32);
    tracep->fullIData(oldp+96,(2U),32);
    tracep->fullIData(oldp+97,(1U),32);
    tracep->fullBit(oldp+98,(1U));
    tracep->fullIData(oldp+99,(8U),32);
    tracep->fullIData(oldp+100,(0x7fU),32);
    tracep->fullBit(oldp+101,(1U));
    tracep->fullIData(oldp+102,(7U),32);
    tracep->fullBit(oldp+103,(0U));
    tracep->fullIData(oldp+104,(7U),32);
}
